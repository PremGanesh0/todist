...
class UndoTaskCard extends StatelessWidget {
  final Task task;
  final int? index;
  const UndoTaskCard({super.key, required this.task, this.index});
      ...
      child: Dismissible(
        ...
        onDismissed: (direction) {
          if (direction == DismissDirection.startToEnd) {
            BlocProvider.of<TaskBloc>(context).add(UndoTaskEvent(task));
