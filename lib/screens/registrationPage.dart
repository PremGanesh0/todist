          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                //   ],
                // ),
                const Text('Unlock Productivity with Task Pareto',style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700),),
           ...
           Padding(
             ...
             const Row(crossAxisAlignment: CrossAxisAlignment.start,
               children: [
                 Text('What should we call you?',textAlign: TextAlign.start, style: TextStyle(fontSize: 16,fontWeight: FontWeight.w700),),
               ],
             ),
                TextField(
 ...
 XFile? image = await imagePicker.pickImage(
  ...
  builder: (context, state) {
    if (state is RegistrationLoading) {
      ...
      return const Text('Resistration is failure');
